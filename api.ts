 ...
 * 
 * @export
 * @interface GetAddressNameInfoMulti200ResponseValue
 */
export interface GetAddressNameInfoMulti200ResponseValue {
    /**
     * 
     * @type {string}
     * @memberof GetAddressNameInfoMulti200ResponseValue
     */
    'name'?: string;
    /**
     * 
...
export interface TransactionRiskReport {
     ...
     * @type {{ [key: string]: TransactionRiskReportDetailsValue; }}
     * @memberof TransactionRiskReport
     */
    'details': { [key: string]: TransactionRiskReportDetailsValue; };
}
/**
 * 
 * @export
 * @interface TransactionRiskReportDetailsValue
 */
export interface TransactionRiskReportDetailsValue {
    /**
     * 
     * @type {Array<RiskReportCategory>}
     * @memberof TransactionRiskReportDetailsValue
     */
    'own_categories'?: Array<RiskReportCategory>;
    /**
     * 
...
export const AddressNameAndCategoryInfoApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {Array<string>} [requestBody] Addresses for which name and category should be returned (maximum of 5000 in one request)
...
export const AddressNameAndCategoryInfoApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAddressNameInfoMulti(chain: string, requestBody?: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{ [key: string]: GetAddressNameInfoMulti200ResponseValue; }>> {
...
export const AddressNameAndCategoryInfoApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getAddressNameInfoMulti(chain: string, requestBody?: Array<string>, options?: any): AxiosPromise<{ [key: string]: GetAddressNameInfoMulti200ResponseValue; }> {
...
export const AggregatedInfoApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        balance: async (currency?: string, accountFilter?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const AggregatedInfoApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async accountProviderHintsList(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<AccountProviderHint>>> {
         ...
         * @throws {RequiredError}
         */
        async accountProvidersList(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<AccountProvider>>> {
         ...
         * @throws {RequiredError}
         */
        async balance(currency?: string, accountFilter?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Balance200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.balance(currency, accountFilter, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const AggregatedInfoApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        accountProviderHintsList(options?: any): AxiosPromise<Array<AccountProviderHint>> {
         ...
         * @throws {RequiredError}
         */
        accountProvidersList(options?: any): AxiosPromise<Array<AccountProvider>> {
         ...
         * @throws {RequiredError}
         */
        balance(currency?: string, accountFilter?: string, options?: any): AxiosPromise<Balance200Response> {
            return localVarFp.balance(currency, accountFilter, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get NFT metadata
...
export class AggregatedInfoApi extends BaseAPI {
     ...
     * @memberof AggregatedInfoApi
     */
    public balance(currency?: string, accountFilter?: string, options?: AxiosRequestConfig) {
        return AggregatedInfoApiFp(this.configuration).balance(currency, accountFilter, options).then((request) => request(this.axios, this.basePath));
    }
...
export const ExchangeRateInfoApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} pairs Currency pairs for which exchange rate should be returned (max 20 per request)
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
         ...
         * @param {string} days Historical dates for which exchange rates should be returned (max 40 per request)
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
...
export const RiskInfoApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [chain] Blockchain identifier
         * @param {Array<string>} [requestBody] Addresses for which risk should be returned (maximum of 5000 in one request)
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getMultipleAddressRiskScore: async (chain?: string, requestBody?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/v1/risk/score`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const RiskInfoApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getMultipleAddressRiskScore(chain?: string, requestBody?: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{ [key: string]: number; }>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getMultipleAddressRiskScore(chain, requestBody, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
...
export const RiskInfoApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getMultipleAddressRiskScore(chain?: string, requestBody?: Array<string>, options?: any): AxiosPromise<{ [key: string]: number; }> {
            return localVarFp.getMultipleAddressRiskScore(chain, requestBody, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Get transaction risk score
...
export class RiskInfoApi extends BaseAPI {
     ...
     * @memberof RiskInfoApi
     */
    public getMultipleAddressRiskScore(chain?: string, requestBody?: Array<string>, options?: AxiosRequestConfig) {
        return RiskInfoApiFp(this.configuration).getMultipleAddressRiskScore(chain, requestBody, options).then((request) => request(this.axios, this.basePath));
    }
...
/**
 * UserAccountManagementApi - axios parameter creator
 * @export
 */
export const UserAccountManagementApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * 
...
/**
 * UserAccountManagementApi - functional programming interface
 * @export
 */
export const UserAccountManagementApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = UserAccountManagementApiAxiosParamCreator(configuration)
    return {
        /**
         * 
         * @summary Connect new account
...
/**
 * UserAccountManagementApi - factory interface
 * @export
 */
export const UserAccountManagementApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    const localVarFp = UserAccountManagementApiFp(configuration)
    return {
        /**
         * 
         * @summary Connect new account
...
/**
 * UserAccountManagementApi - object-oriented interface
 * @export
 * @class UserAccountManagementApi
 * @extends {BaseAPI}
 */
export class UserAccountManagementApi extends BaseAPI {
    /**
     * 
     * @summary Connect new account
     * @param {string} accountProvider URL value from account_providers method
     ...
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof UserAccountManagementApi
     */
    public connectAccount(accountProvider: string, connectAccountRequest?: ConnectAccountRequest, options?: AxiosRequestConfig) {
        return UserAccountManagementApiFp(this.configuration).connectAccount(accountProvider, connectAccountRequest, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public deleteAccount(accountProvider: string, accountId: string, options?: AxiosRequestConfig) {
        return UserAccountManagementApiFp(this.configuration).deleteAccount(accountProvider, accountId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getAccountHint(accountProvider: string, options?: AxiosRequestConfig) {
        return UserAccountManagementApiFp(this.configuration).getAccountHint(accountProvider, options).then((request) => request(this.axios, this.basePath));
    }
}
